#!/bin/bash
# Launcher script for Isaac Piano Demo
# Automatically finds and uses Isaac Sim's Python

set -e

echo "======================================================================"
echo "Isaac Piano Demo Launcher"
echo "======================================================================"
echo
...
# Run the demo using Isaac Sim's Python
echo "Launching piano demo..."
echo "======================================================================"
echo

"$ISAAC_SIM_PATH/python.sh" "$SCRIPT_DIR/isaac_piano_demo.py" "$@"
